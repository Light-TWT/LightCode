...
# Phase 3（桌面端）：受控动态工作区注册稳定错误码。不携带任何根路径、
# 内部堆栈或令牌原文。
DESKTOP_MODE_DISABLED = "DESKTOP_MODE_DISABLED"
DESKTOP_SIDECAR_TOKEN_INVALID = "DESKTOP_SIDECAR_TOKEN_INVALID"
DESKTOP_WORKSPACE_INVALID = "DESKTOP_WORKSPACE_INVALID"
DESKTOP_WORKSPACE_ALREADY_EXISTS = "DESKTOP_WORKSPACE_ALREADY_EXISTS"
